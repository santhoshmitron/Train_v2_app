...
public class Gate {
    ...
    public Gate(String gateNum, String boom1_id, String g_value,String l_value, String bs2_value, String lt_value) {
        this.gateNum = gateNum;
        this.boom1Id = boom1_id;
        this.g_value = g_value;
        this.l_value = l_value;
        this.bs2_value = bs2_value;
    ...
    public String getBs2_value() {
        return bs2_value;
    }
    
    public void setBs2_value(String bs2_value) {
        this.bs2_value = bs2_value;
    }
    ...
    public void setLt_value(String lt_value) {
        this.lt_value = lt_value;
    }
